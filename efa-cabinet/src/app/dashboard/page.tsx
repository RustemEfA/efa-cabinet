    ...
    <>
      ...
      <div className="step-card">
        <div className="step-head">
          ...
          <h2>Узнайте сильные и слабые стороны своего бизнеса</h2>
        </div>
        <p>
        ...
        <p>Это анализ связки: Продукт — Клиент — Конкурент.</p>
        <p>
          <b style={{ color: "var(--white)" }}>Результат:</b> отчёт о том, как потенциальные
